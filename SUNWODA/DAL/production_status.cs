...
namespace SUNWODA_SEVB.Data.DAL
{
    ...
    public partial class production_status
    {
        ...
        public int GetMaxId()
        {
            return DbHelperMySQL.GetMaxID("id", "probably");
        }
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from probably");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into probably(");
            strSql.Append(
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update probably set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from probably ");
            strSql.Append(" where id=@id");
            MySqlParameter[] parameters = { new MySqlParameter("@id", MySqlDbType.Int32) };
            parameters[0].Value = id;
        ...
        public SUNWODA_SEVB.Data.Model.production_status? GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(
                "select id,plc_config_id,user_name,ok_count,ng_count,is_baking,ppm,model,feed_count,discharge_count from probably "
            );
            strSql.Append(" where id=@id");
            MySqlParameter[] parameters = { new MySqlParameter("@id", MySqlDbType.Int32) };
            parameters[0].Value = id;
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from probably T ");
