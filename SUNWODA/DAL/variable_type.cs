...
namespace SUNWODA_SEVB.Data.DAL
{
    ...
    public partial class variable_type
    {
        ...
        public SUNWODA_SEVB.Data.Model.variable_type? GetModel(int id)
        {
            ...
            SUNWODA_SEVB.Data.Model.variable_type model = new SUNWODA_SEVB.Data.Model.variable_type();
        ...
        /// 得到一个对象实体
        /// </summary>
        public SUNWODA_SEVB.Data.Model.variable_type DataRowToModel(DataRow row)
        {
            SUNWODA_SEVB.Data.Model.variable_type model = new SUNWODA_SEVB.Data.Model.variable_type();
            if (row != null)
            {
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "variabletype";
