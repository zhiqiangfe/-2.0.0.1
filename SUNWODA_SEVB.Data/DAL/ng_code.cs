    ...
    public partial class ng_code
    {
        ...
        public bool Add(SUNWODA_SEVB.Data.Model.ng_code model)
        {
            ...
            MySqlParameter[] parameters =
            {
                ...
                new MySqlParameter("@reason", MySqlDbType.VarChar, 50),
            };
        ...
        public SUNWODA_SEVB.Data.Model.ng_code? GetModel(string code)
        {
            ...
            SUNWODA_SEVB.Data.Model.ng_code model = new SUNWODA_SEVB.Data.Model.ng_code();
        ...
        /// 得到一个对象实体
        /// </summary>
        public SUNWODA_SEVB.Data.Model.ng_code DataRowToModel(DataRow row)
        {
            SUNWODA_SEVB.Data.Model.ng_code model = new SUNWODA_SEVB.Data.Model.ng_code();
            if (row != null)
            {
