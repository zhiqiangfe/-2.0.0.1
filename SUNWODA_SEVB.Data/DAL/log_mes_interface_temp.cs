...
namespace SUNWODA_SEVB.Data.DAL
{
    ...
    public partial class log_mes_interface_temp
    {
        ...
        public int GetMaxId()
        {
            return DbHelperMySQL.GetMaxID("id", "log_mes_interface_temp");
        }
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from log_mes_interface_temp");
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(SUNWODA_SEVB.Data.Model.log_mes_interface_temp model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into log_mes_interface_temp(");
            strSql.Append(
                "logdate,method,input_json,output_json,start_time,end_time,consuming_time,success_flag,isDeal)"
            );
            ...
            MySqlParameter[] parameters =
            {
                ...
                new MySqlParameter("@input_json", MySqlDbType.VarChar, 50000000),
                new MySqlParameter("@output_json", MySqlDbType.VarChar, 50000000),
                ...
                new MySqlParameter("@isDeal", MySqlDbType.Int32, 11),
            };
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(SUNWODA_SEVB.Data.Model.log_mes_interface_temp model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update log_mes_interface_temp set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from log_mes_interface_temp ");
            strSql.Append(" where id=@id");
            MySqlParameter[] parameters = { new MySqlParameter("@id", MySqlDbType.Int32) };
            parameters[0].Value = id;
        ...
        /// 得到一个对象实体
        /// </summary>
        public SUNWODA_SEVB.Data.Model.log_mes_interface_temp? GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(
                "select id,logdate,method,input_json,output_json,start_time,end_time,consuming_time,success_flag,isDeal from log_mes_interface_temp "
            );
            strSql.Append(" where id=@id");
            MySqlParameter[] parameters = { new MySqlParameter("@id", MySqlDbType.Int32) };
            parameters[0].Value = id;

            SUNWODA_SEVB.Data.Model.log_mes_interface_temp model = new SUNWODA_SEVB.Data.Model.log_mes_interface_temp();
        ...
        /// 得到一个对象实体
        /// </summary>
        public SUNWODA_SEVB.Data.Model.log_mes_interface_temp DataRowToModel(DataRow row)
        {
            SUNWODA_SEVB.Data.Model.log_mes_interface_temp model = new SUNWODA_SEVB.Data.Model.log_mes_interface_temp();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(
                "select id,logdate,method,input_json,output_json,start_time,end_time,consuming_time,success_flag,isDeal "
            );
            strSql.Append(" FROM log_mes_interface_temp ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from log_mes_interface_temp T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "log_mes_interface_temp";
