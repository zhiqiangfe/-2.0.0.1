...
{
    /// <summary>
    /// 数据访问类:log_mes_interface_weight
    /// </summary>
    public partial class log_mes_interface_weight
    {
        public log_mes_interface_weight() { }
        ...
        public int GetMaxId()
        {
            return DbHelperMySQL.GetMaxID("id", "log_mes_interface_weight");
        }
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from log_mes_interface_weight");
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(SUNWODA_SEVB.Data.Model.log_mes_interface_weight model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into log_mes_interface_weight(");
            strSql.Append(
            ...
            MySqlParameter[] parameters =
            {
                ...
                new MySqlParameter("@input_json", MySqlDbType.VarChar, 5000),
                new MySqlParameter("@output_json", MySqlDbType.VarChar, 5000),
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(SUNWODA_SEVB.Data.Model.log_mes_interface_weight model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update log_mes_interface_weight set ");
            ...
            MySqlParameter[] parameters =
            {
                new MySqlParameter("@logdate", MySqlDbType.DateTime),
                new MySqlParameter("@method", MySqlDbType.VarChar, 50),
                new MySqlParameter("@input_json", MySqlDbType.VarChar, 50000),
                new MySqlParameter("@output_json", MySqlDbType.VarChar, 50000),
                new MySqlParameter("@start_time", MySqlDbType.DateTime),
                new MySqlParameter("@end_time", MySqlDbType.DateTime),
                new MySqlParameter("@consuming_time", MySqlDbType.VarChar, 50),
                new MySqlParameter("@success_flag", MySqlDbType.VarChar, 50),
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from log_mes_interface_weight ");
            strSql.Append(" where id=@id");
            MySqlParameter[] parameters = { new MySqlParameter("@id", MySqlDbType.Int32) };
            parameters[0].Value = id;
        ...
        /// 得到一个对象实体
        /// </summary>
        public SUNWODA_SEVB.Data.Model.log_mes_interface_weight? GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(
                "select id,logdate,method,input_json,output_json,start_time,end_time,consuming_time,success_flag from log_mes_interface_weight "
            );
            strSql.Append(" where id=@id");
            MySqlParameter[] parameters = { new MySqlParameter("@id", MySqlDbType.Int32) };
            parameters[0].Value = id;

            SUNWODA_SEVB.Data.Model.log_mes_interface_weight model =
                new SUNWODA_SEVB.Data.Model.log_mes_interface_weight();
        ...
        /// 得到一个对象实体
        /// </summary>
        public SUNWODA_SEVB.Data.Model.log_mes_interface_weight DataRowToModel(DataRow row)
        {
            SUNWODA_SEVB.Data.Model.log_mes_interface_weight model =
                new SUNWODA_SEVB.Data.Model.log_mes_interface_weight();
            if (row != null)
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM log_mes_interface_weight ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from log_mes_interface_weight T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "log_mes_interface_weight";
