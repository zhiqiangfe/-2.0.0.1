...
{
    public partial class log_http_interface
    {
        private readonly DbHelperMySQL _dbHelper;
        public log_http_interface(DbHelperMySQL dbHelper)
        {
            _dbHelper = dbHelper;
        }
        ...
        public int GetMaxId()
        {
            return _dbHelper.GetMaxID("id", "log_http_interface");
        }
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from log_http_interface");
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(SUNWODA_SEVB.Data.Model.log_http_interface model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into log_http_interface(");
            strSql.Append(
                "logdate,url,method,input_json,output_json,start_time,end_time,consuming_time,success_flag)"
            );
            ...
            MySqlParameter[] parameters =
            {
                ...
                new MySqlParameter("@url", MySqlDbType.VarChar, 150),
            ...
            parameters[3].Value = model.input_json;
            parameters[4].Value = model.output_json;
            parameters[5].Value = model.start_time;
            parameters[6].Value = model.end_time;
            parameters[7].Value = model.consuming_time;
            parameters[8].Value = model.success_flag;
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(SUNWODA_SEVB.Data.Model.log_http_interface model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update log_http_interface set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from log_http_interface ");
            strSql.Append(" where id=@id");
            MySqlParameter[] parameters = { new MySqlParameter("@id", MySqlDbType.Int32) };
            parameters[0].Value = id;
        ...
        /// 得到一个对象实体
        /// </summary>
        public SUNWODA_SEVB.Data.Model.log_http_interface? GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(
                "select id,logdate,url,method,input_json,output_json,start_time,end_time,consuming_time,success_flag from log_http_interface "
            );
            strSql.Append(" where id=@id");
            MySqlParameter[] parameters = { new MySqlParameter("@id", MySqlDbType.Int32) };
            parameters[0].Value = id;

            SUNWODA_SEVB.Data.Model.log_http_interface model = new SUNWODA_SEVB.Data.Model.log_http_interface();
        ...
        /// 得到一个对象实体
        /// </summary>
        public SUNWODA_SEVB.Data.Model.log_http_interface DataRowToModel(DataRow row)
        {
            SUNWODA_SEVB.Data.Model.log_http_interface model = new SUNWODA_SEVB.Data.Model.log_http_interface();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(
                "select id,logdate,url,method,input_json,output_json,start_time,end_time,consuming_time,success_flag "
            );
            strSql.Append(" FROM log_http_interface ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from log_http_interface T ");
